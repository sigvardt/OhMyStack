 ...
 * 1. Detect stack and scope (via ohmystack-diff-scope)
...
\`\`\`bash
source <(${ctx.paths.binDir}/ohmystack-diff-scope <base> 2>/dev/null) || true
...
\`\`\`bash
${ctx.paths.binDir}/ohmystack-specialist-stats 2>/dev/null || true
\`\`\`
...
\`\`\`bash
${ctx.paths.binDir}/ohmystack-learnings-search --type pitfall --query "{specialist domain}" --limit 5 2>/dev/null || true
\`\`\`
