...
[ -z "$_PRETEXT_VENDOR" ] && [ -f ~/.config/opencode/skills/ohmystack/design-html/vendor/pretext.js ] && _PRETEXT_VENDOR=~/.config/opencode/skills/ohmystack/design-html/vendor/pretext.js
