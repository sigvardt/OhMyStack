...
```bash
DISCOVER_BIN=""
[ -x ~/.config/opencode/skills/ohmystack/bin/gstack-global-discover ] && DISCOVER_BIN=~/.config/opencode/skills/ohmystack/bin/gstack-global-discover
[ -z "$DISCOVER_BIN" ] && [ -x .opencode/skills/ohmystack/bin/gstack-global-discover ] && DISCOVER_BIN=.opencode/skills/ohmystack/bin/gstack-global-discover
