...
```bash
~/.config/opencode/skills/ohmystack/bin/gstack-learnings-log '{
  "type": "pitfall",
...
```bash
~/.config/opencode/skills/ohmystack/bin/gstack-review-log '{"skill":"review","timestamp":"TIMESTAMP","status":"STATUS","issues_found":N,"critical":N,"informational":N,"quality_score":SCORE,"specialists":SPECIALISTS_JSON,"findings":FINDINGS_JSON,"commit":"COMMIT"}'
```
