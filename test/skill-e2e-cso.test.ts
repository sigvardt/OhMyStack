...
- Save the report to .ohmystack/security-reports/.`,
    ...
    const reportDir = path.join(csoDir, '.ohmystack', 'security-reports');
...
- Skip the preamble (ohmystack-update-check, telemetry, etc.) — go straight to the audit.
