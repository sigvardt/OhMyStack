...
export const E2E_TOUCHFILES: Record<string, string[]> = {
  ...
  'operational-learning':     ['scripts/resolvers/preamble.ts', 'bin/ohmystack-learnings-log'],
  ...
  'review-army-migration-safety': ['review/**', 'scripts/resolvers/review-army.ts', 'bin/ohmystack-diff-scope'],
  'review-army-perf-n-plus-one':  ['review/**', 'scripts/resolvers/review-army.ts', 'bin/ohmystack-diff-scope'],
  ...
  // Ship
  'ship-base-branch': ['ship/**', 'bin/ohmystack-repo-mode'],
  ...
  // Global discover
  'global-discover':   ['bin/ohmystack-global-discover.ts', 'test/global-discover.test.ts'],
  ...
  // Learnings
  'learnings-show': ['learn/**', 'bin/ohmystack-learnings-search', 'bin/ohmystack-learnings-log', 'scripts/resolvers/learnings.ts'],

  // Session Intelligence (timeline, context recovery, checkpoint)
  'timeline-event-flow':         ['bin/ohmystack-timeline-log', 'bin/ohmystack-timeline-read'],
  'context-recovery-artifacts':  ['scripts/resolvers/preamble.ts', 'bin/ohmystack-timeline-log', 'bin/ohmystack-slug', 'learn/**'],
  'checkpoint-save-resume':      ['checkpoint/**', 'bin/ohmystack-slug'],
  ...
  'codex-review-findings': ['review/**', '.agents/skills/ohmystack-review/**', 'codex/**', 'test/helpers/codex-session-runner.ts', 'lib/worktree.ts'],
  ...
  'gemini-review-findings': ['review/**', '.agents/skills/ohmystack-review/**', 'test/helpers/gemini-session-runner.ts', 'lib/worktree.ts'],


  // Coverage audit (shared fixture) + triage + gates
  'ship-coverage-audit': ['ship/**', 'test/fixtures/coverage-audit-fixture.ts', 'bin/ohmystack-repo-mode'],
  ...
  'ship-triage': ['ship/**', 'bin/ohmystack-repo-mode'],
  ...
  // ohmystack-upgrade
  'ohmystack-upgrade-happy-path': ['ohmystack-upgrade/**'],

  // Deploy skills
  'land-and-deploy-workflow':      ['land-and-deploy/**', 'scripts/gen-skill-docs.ts'],
  'land-and-deploy-first-run':     ['land-and-deploy/**', 'scripts/gen-skill-docs.ts', 'bin/ohmystack-slug'],
  'land-and-deploy-review-gate':   ['land-and-deploy/**', 'bin/ohmystack-review-read'],
...
export const E2E_TIERS: Record<string, 'gate' | 'periodic'> = {
  ...
  // ohmystack-upgrade
  'ohmystack-upgrade-happy-path': 'gate',
...
export const LLM_JUDGE_TOUCHFILES: Record<string, string[]> = {
  ...
  'ohmystack-upgrade/SKILL.md upgrade flow': ['ohmystack-upgrade/SKILL.md', 'ohmystack-upgrade/SKILL.md.tmpl'],
