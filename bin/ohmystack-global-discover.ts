#!/usr/bin/env bun
/**
 * ohmystack-global-discover — Discover AI coding sessions across Claude Code, Codex CLI, and Gemini CLI.
 ...
 *
 * Usage:
 *   ohmystack-global-discover --since 7d [--format json|summary]
 *   ohmystack-global-discover --help
 */
...
function printUsage(): void {
  console.error(`Usage: ohmystack-global-discover --since <window> [--format json|summary]
...
Examples:
  ohmystack-global-discover --since 7d
  ohmystack-global-discover --since 14d --format summary`);
}
