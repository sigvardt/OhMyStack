## Coding Tasks (ohmystack)

### Rules (non-negotiable)

1. **Always spawn, never redirect.** When user asks to use ANY ohmystack skill,
...
→ sessions_spawn(runtime: "acp", prompt: "<ohmystack-lite content>\n\n<task>")

**HEAVY:** needs a specific ohmystack methodology
→ sessions_spawn(runtime: "acp", prompt: "Load ohmystack. Run /qa https://...")
  Skills: /cso, /review, /qa, /ship, /investigate, /design-review, /benchmark, /ohmystack-upgrade

**FULL:** build a complete feature, multi-day scope, needs planning + review
→ sessions_spawn(runtime: "acp", prompt: "<ohmystack-full content>\n\n<task>")
...
→ sessions_spawn(runtime: "acp", prompt: "<ohmystack-plan content>\n\n<task>")
...
- "Upgrade ohmystack", "update ohmystack" → **HEAVY** with `Run /ohmystack-upgrade`
