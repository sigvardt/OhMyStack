# Adding a New Host to ohmystack

ohmystack uses a declarative host config system. Each supported AI coding agent
...
const myhost: HostConfig = {
  ...
  globalRoot: '.myhost/skills/ohmystack',
  localSkillRoot: '.myhost/skills/ohmystack',
  hostSubdir: '.myhost',
  ...
  pathRewrites: [
    { from: '~/.claude/skills/ohmystack', to: '~/.myhost/skills/ohmystack' },
    { from: '.claude/skills/ohmystack', to: '.myhost/skills/ohmystack' },
...
ls .myhost/skills/ohmystack-*/SKILL.md
